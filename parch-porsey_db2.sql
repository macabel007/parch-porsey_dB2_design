...
-- Creating the tables and inserting the various constraint and 
...
DROP TABLE accounts, orders, region, sales_reps, web_events;

-- RUNNING THE Udacity codes to create database and adding the various constraint
...
--14. Pulls the first 10 rows and all columns from the orders table that have 
